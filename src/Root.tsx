...
import { CybersecurityNetwork } from "./compositions/comp0";
import { CybersecurityNetworkMap } from "./compositions/comp1";

export const RemotionRoot: React.FC = () => (
  <>
    <Composition id="CybersecurityNetwork" component={CybersecurityNetwork} width={3840} height={2160} fps={60} durationInFrames={900} />
